...
while not done:
    ...
    center3 = rotate(center3, (300, 300), 0.01, r)
    center4 = rotate(center4, (300, 300), 0.01, r)

    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            done = True
    screen.fill((0, 0, 0))
    pygame.draw.circle(screen, (255, 0, 0), (int(center1[0]), int(center1[1])), 20)
    pygame.draw.circle(screen, (255, 255, 0), (int(center2[0]), int(center2[1])), 20)
    pygame.draw.circle(screen, (0, 0, 255), (int(center3[0]), int(center3[1])), 20)
    pygame.draw.circle(screen, (255, 0, 255), (int(center4[0]), int(center4[1])), 20)
    pygame.display.flip()